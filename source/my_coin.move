...
module my_coin::my_coin {
    ...
    fun create_currency<T: drop>(
        ...
        let url = url::new_unsafe_from_bytes(b"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRechclv827oKORG_WJDawFjbDJBzPdJS2JDQ&s");

        let (treasury_cap, metadata) = coin::create_currency(
            otw, 0,
            b"BC",
            b"Boben Coin",
            b"Boben's First Ever Coin",
            option::some(url),
            ctx
        );
